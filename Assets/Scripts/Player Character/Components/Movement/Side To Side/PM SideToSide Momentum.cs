...
/// to side movement with momentum along with dashing (don't want to build it as a separate script yet).
/// 
/// REM-i
/// </summary>
public class PMSideToSideMomentum : MovementComponentParent
{
    #region Vars
    ...
    public override void MovePlayer()
    {
        ...
        {
            _rb2d.AddForce(new Vector2(_moveVector.x * ((IsDashingEnabled && _isDashing) ? _dashSpeed : _speed), 0));
        }
        else
        {
